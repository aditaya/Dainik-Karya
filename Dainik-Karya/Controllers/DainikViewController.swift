...
class DainikViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        if let item = defaults.array(forKey: "dainikArray")  as? [String] {
            itemArray = item
        }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "DainikItemCell", for: indexPath)
    ...
    @IBAction func addButtonPressed(_ sender: UIBarButtonItem) {
        ...
        let action = UIAlertAction(title: "Add Karya", style: .default) { (action) in
            ...
            self.defaults.setValue(self.itemArray, forKey: "dainikArray")
